  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        backgroundColor: Color(0xFF030406),
        body: Stack(
          children: [
            Align(
                ...
                child: Stack(
                  children: [
                    FlutterFlowVideoPlayer(
                      path: 'assets/videos/VN20250715_204126.mp4',
                      videoType: VideoType.asset,
                      width: MediaQuery.sizeOf(context).width * 1.311,
                      height: MediaQuery.sizeOf(context).height * 1.311,
                      autoPlay: true,
                      looping: true,
                      showControls: false,
